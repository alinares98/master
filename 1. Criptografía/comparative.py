...
# Modo OFB
ciphertext = aes_ofb_encrypt(key, message, iv)
print("Texto cifrado (OFB):", ciphertext)
plaintext = aes_ofb_decrypt(key, ciphertext, iv)
print("Texto original (OFB):", plaintext)

# Modo CFB
ciphertext = aes_cfb_encrypt(key, message, iv)
print("Texto cifrado (CFB):", ciphertext)
plaintext = aes_cfb_decrypt(key, ciphertext, iv)
